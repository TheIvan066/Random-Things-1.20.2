package net.theivan066.randomthingsmod.world.structure;
...
public class ModStructures {
        ...
        public static void registerStructureFeatures() {
            SKY_STRUCTURES = Registry.register(Registries.STRUCTURE_TYPE, new Identifier(RandomThingsMod.MOD_ID, "sky_structures"), () -> SkyStructures.CODEC);
        }
    }